...
(function() {
  var TBError, TBGenerateDomHelper, TBPublisher, TBSession, TBSubscriber, TBSuccess, TBUpdateObjects, getPosition, replaceWithObject;
  ...
  window.TB = {
    ...
    initSession: function(sid, production) {
      if ((production != null) && (typeof production === "boolean")) {
  ...
  TBSession = (function() {
    ...
    function TBSession(sessionId, production) {
